...
public class JsonInput {
    public static ArrayList<Account> deserializeAccounts() {
        String accountPath = "C:\\Users\\Alex\\Documents\\FACULTATE\\ANUL 2\\SEM 1\\POO\\Game\\PROIECT\\accounts.json";
        try {
            ...
            for (int i=0; i < accountsArray.length(); i++) {
                ...
                try {
                    ...
                    for (int j = 0; j < charactersListJson.length(); j++) {
                        ...
                        // instantierea personajelor se face prin Factory Design Pattern
                        Characters newCharacter = CharacterFactory.factory(profession, cname, experience, lvl);
                ...
                Account.Information information = new Account.Information.Builder().setFavouriteGames(favoriteGames).
                        setCredentials(credentials).setPlayerName(name).setCountry(country).build();
